#!/usr/bin/env python3
"""
Generate comprehensive HTML report with optimization results
"""
...
<head>
    ...
    <title>APA Citation Validator - Optimization Report</title>
    <style>
...
<body>
    <div class="header">
        <h1>🎯 APA Citation Validator - Optimization Report</h1>
    ...
    <div class="metrics-grid">
        ...
        <div class="metric-card">
            ...
            <div class="metric-label">Primary optimization target</div>
        </div>
        <div class="metric-card">
            <h3>Precision (Invalid)</h3>
            <div class="metric-value">{metrics['invalid_class']['precision']:.1%}</div>
            <div class="metric-label">True positives / (TP + FP)</div>
        </div>
        <div class="metric-card">
            <h3>Recall (Invalid)</h3>
            <div class="metric-value">{metrics['invalid_class']['recall']:.1%}</div>
            <div class="metric-label">True positives / (TP + FN)</div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="confusion-matrix">
            ...
            <div class="cm-cell cm-fp">FP: {metrics['invalid_class']['fp']}</div>
...
if __name__ == "__main__":
    ...
    if not model_path.exists():
        ...
        logger.error("Run run_gepa_optimization.py first!")
        sys.exit(1)
