...
OUTPUT_FILE = "Checker_Prompt_Optimization/gemini_2_5_flash_regular_run3_results.json"
...
async def run_regular_test():
    ...
    print(f"🎯 Gemini 2.5-Flash Regular Approach Test - Run 3", flush=True)
    print("=" * 60, flush=True)
    ...
    results = {
        "metadata": {
            ...
            "model": MODEL,
            "test_type": "gemini_2_5_flash_regular_run3",
