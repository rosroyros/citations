...
# Paths
DATASET_PATH = os.path.join(PROJECT_ROOT, "Checker_Prompt_Optimization/chicago_holdout_set.jsonl")
PROMPT_PATH = os.path.join(PROJECT_ROOT, "backend/prompts/validator_prompt_chicago17_v1.2.txt")
OUTPUT_FILE = os.path.join(PROJECT_ROOT, "Checker_Prompt_Optimization/chicago_holdout_results.json")
