...
OUTPUT_FILE = "Checker_Prompt_Optimization/gemini_3_flash_preview_results.json"
...
async def run_regular_test():
    ...
    print(f"🎯 Gemini 3 Flash Preview Regular Approach Test", flush=True)
    print("=" * 60, flush=True)
    ...
    results = {
        "metadata": {
            ...
            "model": MODEL,
            "test_type": "gemini_3_flash_preview_regular",
