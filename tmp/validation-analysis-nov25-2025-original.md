...
10. Alkhuzaimi, F., Rainey, D., Wilson, C.B., & Bloomfield, J. (2024). The impact of mobile health interventions on service users' health outcomes and the role of health professions: a systematic review o... (appears 3 times - likely duplicate submissions)
...
12. Guimarães, R. C. (2017). Capítulo 5 – Escoamento Superficial. In R. C. Guimarães, S. Shahidian, & C. M. Rodrigues (Eds.), _Hidrologia Agrícola_, 2.ª edição. ECT e ICAAM.​ http://hdl.handle.net/10174/2... (appears 3 times - likely duplicate submissions)
...
22. All Things Considered. (2025, November 20). _How education department changes could affect students_ [Audio file; Broadcast transcript]. National Public Radio.https://cd203qo5b-mp02-y-https-link-gale-... (appears 3 times - duplicate submissions)
...
28. Diabetes UK. (2024). _Diabetes prevalence 2024_. _https://www.diabetes.org.uk/about-us/about-the-charity/our-strategy/statistics_ **(Appears 3 times - duplicate submissions)**
...
## Detailed Analysis of Duplicate Submission Patterns

### Pattern #1: User Frustration with Slow Processing

**Alkhuzaimi systematic review citations (3 submissions)**
- **20:37:32** - Job: (no job ID shown) - 35.8s processing time - SLOW REQUEST warning
- **20:44:06** - ~7 minutes later - User resubmits same citation - 35.0s processing time
- **20:51:37** - ~7 minutes later - User resubmits again with minor formatting change ("systematic review o..." → "A systematic review...")

**Pattern**: User submitted the same citation 3 times over 14 minutes due to extremely slow processing (35+ seconds each). The slow response times likely caused the user to think the system wasn't working.

### Pattern #2: Systematic Testing/Editing

**Diabetes UK statistics citations (3 submissions)**
- **20:19:05** - Job cb33c9db-7026-4d75-98a2-3b7d3466c4d7 - 57.2s processing time - EXTREMELY SLOW
- **20:24:03** - Job 1bcaca72-20fa-470f-8297-b754cb3c1238 - 54.8s processing time - 5 minutes later
- **20:27:05** - Job 71690c92-ac5c-446c-9595-1f73874a5895 - 62.7s processing time - 3 minutes later

**Pattern**: Same user systematically resubmitting identical citation every few minutes, likely testing different variations or frustrated with 1+ minute response times. All three took ~1 minute to process.

### Pattern #3: Multiple Citation Variations Testing

**NPR All Things Considered episode citations (4 submissions)**
- **04:20:28** - Job f38a2774-becc-4014-ba00-f1bb0f934db9 - 38.5s processing time
- **04:23:55** - Job f476fcf5-0c01-47e5-a5be-54711661ad33 - 31.2s processing time (3+ minutes later)
- **04:57:52** - Job 52bc9802-1482-4a9c-b199-ea7025f0c7c8 - Different citation format (appears to be same content)
- **05:09:37** - Job 860434e6-2eb5-457d-ad62-22a52bfca819 - Long citation (1246 chars, possibly multiple citations)

**Pattern**: User testing different citation formats for the same media content, possibly trying to find the correct way to cite broadcast transcripts. Each submission took 30+ seconds.

### Root Cause Analysis

**Primary Driver**: **Extremely slow OpenAI API response times**
- Average processing time: 30-60+ seconds per citation
- All duplicates show "SLOW REQUEST" warnings (>30s threshold)
- Users likely think the system is broken and resubmit

**Secondary Issues**:
- No immediate feedback to users about processing status
- No indication that their submission was received and being processed
- Users can't distinguish between "still processing" vs "failed/lost"

**User Behavior Patterns**:
1. **Impatience**: Submit → wait ~30 seconds → think it failed → resubmit
2. **Testing**: Try different citation formats when first one is slow
3. **Frustration**: Multiple resubmissions of identical content

**Impact on System**:
- Wastes OpenAI API credits (3-4x cost per citation)
- Increases queue length for other users
- Creates misleading usage statistics
- Contributes to the 87% "missing validation" rate (many are duplicates that may not complete)
