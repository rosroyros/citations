...
**Round 3 Updates (Final Polish):**
- Refined regex to `[a-zA-Z0-9._:-]+` to safely support alphanumeric IDs with punctuation.
- Added database indexes for `results_gated` and `results_revealed_at`.
- Added warning logging when `update_reveal_status` affects 0 rows (orphan records).
- Normalized all boolean storage to integer `1` or `0` in database insert logic.
- Added tests for complex job IDs and orphan reveal events.

## Code Changes to Review

Review the git changes between these commits:
- BASE_SHA: c8cd1033a6730f478b8fea6c9abe5f2dd25e1e12
- HEAD_SHA: 0b088ffd804d6d54c9a0966612e8fe71ac0be747
