...
**3. Send to Claude for guidance:**

```bash
cat ./tmp/<issue-id>-ask-request-round-<N>.md | claude -p --dangerously-skip-permissions 2>&1 | tee ./tmp/<issue-id>-ask-response-round-<N>.md
```
