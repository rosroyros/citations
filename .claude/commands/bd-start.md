...
echo ""
echo "3. Frontend visual/UX changes MUST include Playwright tests"
echo ""
...
echo ""
echo "1. Commit all changes (oracle-review needs committed code)"
echo "2. Update description with final summary"
echo "3. Run: bd label add $TASK_ID needs-review"
echo "4. Run: /oracle-review (external review using claude -p)"
echo "5. After approval: bd close $TASK_ID --reason \"[summary]\""
echo "6. Run: bd sync"
echo ""
' "$1"
