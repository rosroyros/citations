#!/usr/bin/env python3
"""
Run consistency tests on citation validation models.
Tests each model 3 times with temperature=1 to measure consistency and ensemble performance.
"""
import json
import os
...
def run_consistency_test(model_name, run_number):
    ...
    for i, item in enumerate(test_set, 1):
        ...
        try:
            # Determine temperature and reasoning_effort based on model
...
models_to_test = [
    ('gpt-5-mini', 'GPT-5-mini_optimized'),
    ('gpt-4o-mini', 'GPT-4o-mini_optimized')
]
...
for model_id, model_label in models_to_test:
    ...
    test_results[model_label] = model_runs
...
summary_file = 'Checker_Prompt_Optimization/consistency_test_summary.json'
