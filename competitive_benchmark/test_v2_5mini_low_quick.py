"""
Test v2 prompt with GPT-5-mini + reasoning_effort=low (5 citations validation)
"""
import json
import os
import sys
...
def test_model(citations, round_num=1):
    ...
    results = []
    output_file = Path(f'GPT-5-mini_v2_low_round{round_num}_quick_5.jsonl')
...
def main():
    print("="*70)
    print("VALIDATION TEST: V2 Prompt + GPT-5-mini + Low Reasoning")
    print("="*70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: V2 + 5mini + Low (Quick Validation)")
    print(f"{'='*70}")
