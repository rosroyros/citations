"""
Test v2 prompt with GPT-4o-mini (5 citations validation)
"""
import json
import os
import sys
...
def test_model(citations, round_num=1):
    """Test with GPT-4o-mini (no reasoning_effort)."""
    results = []
    output_file = Path(f'GPT-4o-mini_v2_default_round{round_num}_quick_5.jsonl')
...
def main():
    print("="*70)
    print("VALIDATION TEST: V2 Prompt + GPT-4o-mini")
    print("="*70)
    ...
    print(f"\n{'='*70}")
    print(f"RESULTS: V2 + 4o-mini (Quick Validation)")
    print(f"{'='*70}")
